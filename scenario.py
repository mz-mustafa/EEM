...
class Scenario:
    ...
    def available_sources(all_sources=True):
        if all_sources:
            return ["Solar", "Wind", "Gas Generator", "HFO Generator",
                    "HFO+Gas Generator", "Grid", "Diesel Generator", "BESS"]
        else:
            return ["Solar", "Wind", "Gas Generator", "HFO Generator",
                    "HFO+Gas Generator", "Grid", "Diesel Generator"]
    ...
    def scenario_include_stable_sources(self):
        return any(source_name in self.sources for source_name in
                   ['Grid', 'Gas Generator', 'HFO Generator', 'HFO+Gas Generator'])
    ...
    def energy_calculation(self):
        ...
        for year in range(1, self.n + 1):
            for month in range(1, 13):
                ...
                for src_name in ['Gas Generator', 'HFO Generator', 'HFO+Gas Generator', 'Grid']:
                    ...
                    if src_name in self.sources:
                        ...
                        if num_pot_failures == 0:
                            ...
                            for alt_src_name in ["Gas Generator", "Grid", "HFO Generator",
        ...
        for y in range(1, self.n + 1):
            ...
            for m in range(1, 13):
                ...
                for src_name in self.available_sources(all_sources=True):
                    ...
                    if src_name not in ['BESS', 'Solar', 'Wind', 'Grid']:
    ...
    def emissions_calculation(self):
        ...
        for y in range(1, self.n + 1):
            for m in range(1, 13):
                ...
                for src_name in ['Gas Generator', 'HFO Generator', 'HFO+Gas Generator', 'Diesel Generator','Grid']:
